...
#pragma region Reservation and Creation
	...
	template<typename KeyType, typename ValueType>
	inline bool TActivatableFlatMap<KeyType, ValueType>::EraseAt(size_t index)
	{
	...
	template<typename KeyType, typename ValueType>
	inline bool TActivatableFlatMap<KeyType, ValueType>::Add(const KeyType& key, const ValueType& value, bool activateOnCreation)
	{
	...
	template<typename KeyType, typename ValueType>
	inline bool TActivatableFlatMap<KeyType, ValueType>::Retrieve(KeyType&& key, ValueType&& value, bool activateOnCreation)
	{
