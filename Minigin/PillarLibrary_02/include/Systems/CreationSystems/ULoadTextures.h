...
namespace Pillar {
	...
	public:
		~STextureRegistry();
		static UTexture& GetTextureData(const std::string& textureName);
		...
		static UTexture& GetFontData(const std::string& text, const std::string& fontFile, int pointSize, const Color4f& color);
		static void Delete();
