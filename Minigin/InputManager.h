...
namespace dae
{
	...
	class SInputController final : public IStartSystem {

	public:
		SInputController(const InputControllerData& defaultData = InputControllerData{}) : m_Data(defaultData) {}
		~SInputController()noexcept {}
		virtual void Start() override {
			InputManager::GetInstance().SetData(m_Data);
		}
